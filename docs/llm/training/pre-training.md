...
同时，预训练成本随着模型规模快速增长，需要依赖 [扩展定律](../architecture/scaling-law.md)、[混合专家模型](../architecture/mixture-of-experts.md) 和 [高效架构](../architecture/transformer.md#efficient-transformer) 控制成本。
